...
//========================================================================================
	...
	void expectSkylerJesseComplete(Flux<User> flux) {
		StepVerifier.create(flux)
				.assertNext(user -> user.getUsername().equals(User.SKYLER.getUsername()))
				.assertNext(user -> user.getUsername().equals(User.JESSE.getUsername()))
				.verifyComplete();
	}
...
//========================================================================================
	...
	void expect3600Elements(Supplier<Flux<Long>> supplier) {
				StepVerifier.withVirtualTime(supplier)
						...
						.thenAwait(Duration.ofSeconds(9500))
